...
Download [singularity](https://www.sylabs.io/singularity/) image (1.3gb) (singularity is similar to docker but safe for clusters)
...
```
This file is ~1.3Gb, so please make sure you have enough space for it. You can also download manually [here](https://drive.google.com/open?id=1sknDK6ph_g6SYAX0s4XUecs50Unu6Gk4)
